---
title: "Single-cell Clustering based on effective noise reduction through ensenble similarity network"
...
![Fig. 1 Graphical overview of SICLEN](overview.png){ width=80% }
...
![Fig. 2 Low-dimensional visualization of the clustering resutls](sample_tsne.png){ width=50% }
